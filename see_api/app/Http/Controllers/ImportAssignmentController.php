          ...
          foreach ($sheets as $key => $row) {
            ...
            if ($validator->fails()) {
              ...
              WHERE
                ...
                $empResult->knowledge_point = (empty($job_code_data[0]->knowledge_point)) ? 0 :$job_code_data[0]->knowledge_point;
                $empResult->capability_point = (empty($job_code_data[0]->capability_point)) ? 0 :$job_code_data[0]->capability_point;
                $empResult->total_point = (empty($job_code_data[0]->total_point)) ? 0 :$job_code_data[0]->total_point;
                $empResult->baht_per_point = (empty($job_code_data[0]->baht_per_point)) ? 0 :$job_code_data[0]->baht_per_point;
                $empResult->pqpi_amount = (empty($job_code_data[0]->pqpi_amount)) ? null :$job_code_data[0]->pqpi_amount;
                $empResult->fix_other_amount = (empty($job_code_data[0]->fix_other_amount)) ? null :$job_code_data[0]->fix_other_amount;
                $empResult->mpi_amount = (empty($job_code_data[0]->mpi_amount)) ? null :$job_code_data[0]->mpi_amount;
                $empResult->pi_amount = (empty($job_code_data[0]->pi_amount)) ? null :$job_code_data[0]->pi_amount;
                $empResult->var_other_amount = (empty($job_code_data[0]->var_other_amount)) ? null :$job_code_data[0]->var_other_amount;
