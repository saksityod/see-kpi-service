...
class AppraisalController extends Controller
{
	...
	public function show(Request $request, $emp_result_id)
	{
		...
		if($head[0]->emp_code==Auth::id()) {
			$items = DB::select("
				select DISTINCT b.item_name,a.item_desc ,b.formula_desc,uom.uom_name,uom.is_date ,b.structure_id, c.structure_name, d.form_id, d.app_url, c.nof_target_score, a.*, e.perspective_name, a.weigh_score, f.weigh_score total_weigh_score, a.weight_percent, g.weight_percent total_weight_percent, al.no_weight,
