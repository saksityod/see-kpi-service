...
class BonusReportController extends Controller
{
    ...
    $Query_CalcutationMode = "
      ...
      foreach ($AllOrg as $org) {
        ...
        $org->ValueManagerBU = $this->ValueManagerOrg($org->parent_org_id, $period_id, $appraisal_year);
        ...
        $org->ValueManagerDivision = $this->ValueManagerOrg($org->org_id, $period_id, $appraisal_year);
    ...
    public function ValueManagerOrg($org_id, $period_id, $appraisal_year){
