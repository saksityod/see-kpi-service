...
{	
	...
	// Import Assignment //
	Route::get('import_assignment/org_level_list', 'ImportAssignmentController@org_level_list');
	Route::get('import_assignment/emp_level_list', 'ImportAssignmentController@emp_level_list');
